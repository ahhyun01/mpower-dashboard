...
angular.module('mpowerDashboard')
  .controller('TriageController', ['$scope', '$timeout', '$http', function ($scope, $timeout, $http) {
    $scope.stories = [];
    ...
    // Get stories with tag: unstarted, in sorted order by created_date descending.
    $http({
      method: 'GET',
      url: 'https://www.pivotaltracker.com/services/v5/projects/861879/stories?with_state=unstarted'
